...
class Pedido
{
    ...
    {
        $sql = "SELECT p.id, nombre, apellido, email, total, fecha FROM pedidos p INNER JOIN clientes c ON p.cliente_id = c.id ORDER BY p.id DESC";
    ...
    {
        $sql = "SELECT p.id, nombre, apellido, email, total, fecha FROM pedidos p INNER JOIN clientes c ON p.cliente_id = c.id WHERE p.id = :id";
    ...
    {
        $sql = "SELECT p.id, nombre, apellido, email, total, fecha FROM pedidos p INNER JOIN clientes c ON p.cliente_id = c.id ORDER BY p.id DESC LIMIT 10";
